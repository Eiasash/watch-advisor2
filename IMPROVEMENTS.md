...
from): genuine = active non-replica, replica = active replica, a pending count, Rikka SS caveat kept.
Can't drift on future trades. +1 guard test. Backend-only; 3785 green.
