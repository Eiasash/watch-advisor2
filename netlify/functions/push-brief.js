...
WATCH COLLECTION: Grand Seiko Snowflake (silver, grey/navy/titanium straps), Grand Seiko Rikka (green, teal alligator default or stainless-steel bracelet — NOT titanium; titanium is Snowflake only), Cartier Pasha 41mm grey (black alligator preferred — bracelet poor fit; navy alligator AliExpress aftermarket received Apr 30 2026), Cartier Santos Large white/gold (bracelet, brown calfskin, brown alligator, or cobalt-blue alligator), Santos Octagon YG vintage, GP Laureato 42mm blue (integrated bracelet), JLC Reverso navy (navy alligator), Tudor BB41 black/red (bracelet, brown distressed, black leather, NATO, Laco brown cross-strap), TAG Monaco (black or brown rally), Omega Speedmaster (10 straps incl bracelet — pick from its own straps[] only), Rolex GMT-Master II (Oyster bracelet), Hanhart Pioneer (black bund-style OEM + 5 aftermarket straps), Laco Flieger (own distressed brown leather strap).
