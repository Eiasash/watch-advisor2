...
OUTPUT SCHEMA — return ONLY valid JSON matching this shape:
{
  ...
  "watchId": "watch_id — must EXACTLY match one of these (no brand prefixes, no underscores added): snowflake|rikka|pasha|laureato|reverso|santos_large|santos_octagon|blackbay|datejust|go-seventies-chrono|speedmaster|hanhart|laco|perception|iwc_perpetual|iwc_ingenieur|vc_overseas|santos_35|alpine_eagle|royal_oak|gmt_meteorite|daydate|op_grape|op_pistachio|breguet_tradition",
