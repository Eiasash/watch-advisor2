...
export const WATCH_COLLECTION = [
  ...
  { id:"go-seventies-chrono", brand:"Glashütte Original", model:"Seventies Chronograph Panorama Date", ref:"1-37-02-03-02-70", dial:"blue", strap:"navy alligator", formality:7, style:"sport-elegant", lug:20, size:40, priceILS:30000, genuine:true, straps:[ {id:"go-seventies-navy-gator", label:"Navy Louisiana alligator (OEM, folding deployant)", color:"navy", type:"leather", useCase:"Default — dressy / smart casual, OEM blue alligator with signed folding deployant"} ] },
